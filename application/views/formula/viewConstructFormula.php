...
*/
        ...
        $( "#clearformula" ).click(function() {
          ...
          $('#field-rp_pre_value').attr('value', 0); 
          $('#field-rp_post_value').attr('value', 0); 
           $('#field-rp_formula').attr('value', 0); 
            $('#formula').attr('value', 0); 
});
...
<?php
	...
	foreach($hasil as $h=>$hh)
	{
		echo "<input type='text' placeholder='formula value' readonly='readonly' id='field-rp_pre_value' name='rp_pre_value' value='".$hh->rp_pre_value."' />";
		
	}

	foreach($result as $r=>$v)
	{
		echo "<input type='hidden' id='field-rule_id' value='".$v->rule_id."' name='rule_id' />";
	}
...
<div class="col-sm-4">
      ...
      <div class="col-sm-3">
        ...
        <table id="example2" width="100%">
          <tr>
            <td><!-- Standard button -->
            <button style="width:100%" value="7" type="button" class="btn btn-default">7</button>
          </td>
            <td><!-- Standard button -->
            <button style="width:100%" value="8" type="button" class="btn btn-default">8</button>
          </td>
            <td><!-- Standard button -->
            <button style="width:100%" value="9" type="button" class="btn btn-default">9</button>
          </td>
            <td><!-- Standard button -->
           ...
           <tr>
            <td><!-- Standard button -->
            <button style="width:100%" value="4"  type="button" class="btn btn-default">4</button>
          </td>
            <td><!-- Standard button -->
            <button style="width:100%" value="5"  type="button" class="btn btn-default">5</button>
          </td>
            <td><!-- Standard button -->
            <button style="width:100%" value="6"  type="button" class="btn btn-default">6</button>
          </td>
            <td><!-- Standard button -->
            <button style="width:100%" value="*"  type="button" class="btn btn-default">*</button>
          </td>
           ...
           <tr>
            <td><!-- Standard button -->
            <button style="width:100%" value="1"  type="button" class="btn btn-default">1</button>
          </td>
            <td><!-- Standard button -->
            <button style="width:100%" value="2" type="button" class="btn btn-default">2</button>
          </td>
            <td><!-- Standard button -->
            <button style="width:100%" value="3"  type="button" class="btn btn-default">3</button>
          </td>
            <td><!-- Standard button -->
            <button style="width:100%" value="-"  type="button" class="btn btn-default">-</button>
          </td>
           ...
           <tr>
            <td colspan="2"><!-- Standard button -->
            <button style="width:100%" value="0" type="button" class="btn btn-default">0</button>
          </td>
            <td><!-- Standard button -->
            <button style="width:100%" value="." type="button" class="btn btn-default">.</button>
          </td>
