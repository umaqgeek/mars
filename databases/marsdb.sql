...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 15, 2014 at 06:40 PM
...
('0e035cddc626b7befca2fe27c409815b', '::1', 'Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/36.0.1985.103 Safari/537.36', 1405442401, 'a:10:{s:9:"user_data";s:0:"";s:7:"user_id";s:1:"1";s:7:"role_id";s:1:"1";s:8:"username";s:5:"admin";s:9:"user_date";s:19:"2014-06-25 07:44:41";s:13:"user_modified";s:19:"2014-06-25 07:44:41";s:15:"user_last_login";s:19:"2014-07-15 08:21:47";s:8:"magicnum";s:32:"5c7a5ae3a37e6ef4ff9ffdff1785ee55";s:16:"email_activation";s:1:"1";s:9:"logged_in";b:1;}');
...
INSERT INTO `layer_tool` (`layer_tool_id`, `layer_id`, `tool_id`) VALUES
(1, 1, 1);
...
INSERT INTO `project` (`project_id`, `structure_number`, `project_name`, `project_number`, `section_number`, `plf_length`, `overlength`, `mass`) VALUES
(1, 'ST15261797', 'test', '213', '231', 231, 23, NULL),
(2, 'ST15261797', 'testing', 'test', '131', 321, 232, NULL),
(3, 'ST15261797', '2', '23', '23', 23, 23, NULL),
(4, 'ST15261797', '23', '32', '32', 12, 23, NULL),
(5, 'ST15261797', 'haha', 'haha', 'gga', 23, 32, NULL);
...
INSERT INTO `rule` (`rule_id`, `rule_number`, `param1`, `param2`, `param3`, `param4`, `param5`, `param6`, `param7`, `param8`, `param9`, `param10`, `param11`, `param12`) VALUES
(1, '1', '175', '203.2', 'OD-40', '16 x O18', '30', '362', '170', '', '', '', '', '');
...
INSERT INTO `tool` (`tool_id`, `tool_code`, `tool_description`, `nominal_type`, `rule_id`) VALUES
(1, 'MANDREL', 'Mandrel', 'OD Nominal', 1),
(2, 'INTERNAL CALIPER', 'Internal Caliper', 'OD Nominal', 0);
...
(1, 1, 'admin', '21232f297a57a5a743894a0e4a801fc3', '2014-06-25 07:44:41', '2014-06-25 07:44:41', '2014-07-15 16:44:35', '5c7a5ae3a37e6ef4ff9ffdff1785ee55', 1),
...
--
ALTER TABLE `rule`
  ADD CONSTRAINT `rule_ibfk_1` FOREIGN KEY (`rule_id`) REFERENCES `tool` (`rule_id`) ON DELETE CASCADE ON UPDATE CASCADE;
